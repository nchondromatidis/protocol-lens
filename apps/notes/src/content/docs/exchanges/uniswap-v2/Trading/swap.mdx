...
| 9    | Fee-adjust balance0             | balance0Adjusted = 99 * 1000 - 0 * 3 = 99,000               |
| 10   | Fee-adjust balance1             | balance1Adjusted = 202,100 * 1000 - 2,100 * 3 = 202,093,700 |
| 11   | Check                           | 99,000 * 202,093,700 >= 100 * 200,000 * 1000^2              |
