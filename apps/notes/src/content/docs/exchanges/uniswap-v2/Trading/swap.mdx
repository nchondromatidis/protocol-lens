...
<div className='codeBlock flex flex-col items-center'>
  $$
  (x+\Delta x)(y-\Delta y)
  =
...
- the success criteria is that fee-adjusted k must not go down (fees break the equality)
...
|------|---------------------------------|-------------------------------------------------------------|
| 1    | Old reserves                    | reserve0 = 100, reserve1 = 200,000                          |
| 2    | Old k                           | 100 * 200,000 = 20,000,000                                  |
| 3    | Trader wants out                | amount0Out = 1, amount1Out = 0                              |
| 4    | Pool sends out                  | 1 token0                                                    |
| 5    | Balances after user sends input | balance0 = 99, balance1 = 202,100                           |
| 6    | Compute input                   | amount0In = 99 - (100 - 1) = 0                              |
| 7    | Compute input                   | amount1In = 202,100 - (200,000 - 0) = 2,100                 |
| 8    | Fee-adjust balance0             | balance0Adjusted = 99 * 1000 - 0 * 3 = 99,000               |
| 9    | Fee-adjust balance1             | balance1Adjusted = 202,100 * 1000 - 2,100 * 3 = 202,093,700 |
| 10   | Check                           | 99,000 * 202,093,700 >= 100 * 200,000 * 1000^2              |
| 11   | Result                          | True, so swap succeeds                                      |
